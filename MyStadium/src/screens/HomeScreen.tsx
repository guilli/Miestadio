...
const styles = StyleSheet.create({
  ...
  selectorsRow: { backgroundColor: "#fff", paddingHorizontal: 12, paddingTop: 6, paddingBottom: Platform.OS === "ios" ? 8 : 4, borderBottomWidth: 1, borderBottomColor: "#E0E0E0", gap: 6 },
